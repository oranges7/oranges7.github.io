...
Reads:
 ...
 - class: File
   location: "R1.fastq.gz"
 - class: File
   location: "R2.fastq.gz"


Reference_Archive:
   class: File
   location: "/BioData/08.ref/bd/RhapRef_Human_WTA_2023-02.tar.gz"
     

Maximum_Threads: 24


(r_sc)$ cat Runtask_con.sh
/BioData/00.Software/03.BD_CWL/rhapsodyPipeline-2.2.1/rhapsody pipeline --outdir /BioData/03.Project/23.bd/01.run/con --tmpdir-prefix /BioData/03.Project/23.bd/02.tmp /BioData/03.Project/23.bd/01.run/con.yml
...
### 上游分析
- **核心工具**：**dnbc4tools**。
	- [DNBelab_C_Series_HT_scRNA-analysis-software/doc/quickstart.md at version3.0 · MGI-tech-bioinformatics/DNBelab_C_Series_HT_scRNA-analysis-software](https://github.com/MGI-tech-bioinformatics/DNBelab_C_Series_HT_scRNA-analysis-software/blob/version3.0/doc/quickstart.md)
- 代码示例：
```sh
$dnbc4tools rna run \
